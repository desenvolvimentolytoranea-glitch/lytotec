-- Primeiro, verificar quem criou o apontamento original
-- Transferir apenas o operador_id, mantendo o created_by original
...
-- Atualizar apontamentos de equipe por ID
...
RETURNS TRIGGER AS $$
BEGIN
  -- Verificar duplicação por nome completo (apenas funcionários ativos)
  IF EXISTS (
