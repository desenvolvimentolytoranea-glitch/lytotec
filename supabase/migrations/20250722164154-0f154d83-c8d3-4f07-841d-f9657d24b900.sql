-- =======================================================================================
-- CORRECTED DATABASE STRUCTURE MIGRATION
-- Version: 1.0.1
-- Description: Complete implementation of LYTO system database structure (Fixed)
-- =======================================================================================
...
BEGIN
    IF NOT EXISTS (SELECT 1 FROM information_schema.table_constraints 
                   WHERE constraint_name = 'fk_equipes_encarregado') THEN
    ...
    IF NOT EXISTS (SELECT 1 FROM information_schema.table_constraints 
                   WHERE constraint_name = 'fk_equipes_apontador') THEN
        ALTER TABLE public.bd_equipes 
...
BEGIN
    ...
    IF NOT EXISTS (SELECT 1 FROM information_schema.triggers WHERE trigger_name = 'update_funcionarios_updated_at') THEN
    ...
    IF NOT EXISTS (SELECT 1 FROM information_schema.triggers WHERE trigger_name = 'update_veiculos_updated_at') THEN
    ...
    IF NOT EXISTS (SELECT 1 FROM information_schema.triggers WHERE trigger_name = 'calculate_tonelada_real_trigger') THEN
...
INSERT INTO bd_funcoes_permissao (nome_funcao, descricao, permissoes) VALUES
    ('SuperAdm', 'Super Administrador - Acesso Total', (SELECT ARRAY_AGG(id) FROM bd_permissoes)),
