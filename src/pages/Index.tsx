      ...
      <section className="py-16 md:py-20 bg-gray-50">
        <div className="container max-w-7xl mx-auto px-6">
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-8">
            {["Cliente 1", "Cliente 2", "Cliente 3", "Cliente 4", "Cliente 5", "Cliente 6"].map((client, index) => (
              <div
                key={index}
                className="aspect-square bg-white rounded-lg border border-gray-200 flex items-center justify-center p-6 hover:shadow-lg transition-shadow duration-300"
              >
